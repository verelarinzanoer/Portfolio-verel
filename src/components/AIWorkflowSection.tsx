...
const steps = [
  ...
  },
  {
    ...
    desc: "Layouts first, visuals later. Quick wireframes to lock in the logic. I move fast here, because the goal is alignment on structure before we invest in polish.",
  ...
  },
  {
    ...
    desc: "Product photos, illustrations, brand assets, all AI-generated and reviewed by me. Every output gets a human eye before it ships.",
